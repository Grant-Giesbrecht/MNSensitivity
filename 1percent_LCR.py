...
ax.semilogx(f_mhz, spec_L1L, label='L1 1% variation', color=(0, 0, .8))
ax.semilogx(f_mhz, spec_C1C, label='C1 1% variation', color=(.8, 0, 0))
ax.semilogx(f_mhz, spec_Rs1, label='Rs 1% variation', color=(.4, .4, .4))
ax.grid(True)
ax.legend()
...
ax.semilogx([500, 500], [min(spec_Rs1), max(spec_C1C)], linestyle='--', linewidth=1.5, color=(.1, .1, .1))
